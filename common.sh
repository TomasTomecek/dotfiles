...
alias prtb="podman run --rm -ti -v $(pwd):/src:Z registry.fedoraproject.org/fedora:38 bash"
alias sprtb="sudo podman run --rm -ti -v $(pwd):/src:Z registry.fedoraproject.org/fedora:38 bash"
