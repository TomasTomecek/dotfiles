...
alias drtb="docker run --rm -ti -v $(pwd):/src:Z -v /run/docker.sock:/run/docker.sock registry.fedoraproject.org/fedora:30 bash"
alias prtb="podman run --rm -ti -v $(pwd):/src registry.fedoraproject.org/fedora:30 bash"
alias sprtb="sudo podman run --rm -ti -v $(pwd):/src:Z registry.fedoraproject.org/fedora:30 bash"
